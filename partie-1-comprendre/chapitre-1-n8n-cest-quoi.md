...
{% hint style="info" %}
Cette sous-partie explique ce qu'est n8n, comment il se positionne face à Zapier et Make, et quels concepts de base vous devez maîtriser. À la fin, vous saurez lire un workflow simple et comprendre ce que n8n peut automatiser seul.
{% endhint %}
...
{% hint style="success" %}
Exemple concret : vous pouvez détecter chaque nouveau formulaire reçu sur votre site, créer automatiquement le contact dans votre CRM, puis envoyer un email de bienvenue sans intervention manuelle.
{% endhint %}
