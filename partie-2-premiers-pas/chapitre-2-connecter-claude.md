...
{% hint style="info" %}
Cette sous-partie explique comment obtenir une clé API Anthropic, la configurer dans n8n, puis tester un premier appel à Claude. Vous allez comprendre les réglages essentiels du nœud et la structure de sa réponse.
{% endhint %}
...
{% hint style="warning" %}
Ne partagez jamais votre clé API Anthropic. Elle donne accès à votre compte et génère des coûts. Stockez-la dans les variables d'environnement n8n, pas en clair dans le workflow.
{% endhint %}
